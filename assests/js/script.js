...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Mehdi Njema";
        $("#favicon").attr("href","assests/images/mehdi_Njema-removebg-preview.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Front End Developer", "Back End Developer", " With QA Testing Skills"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
$("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init("wJfb7NFbiA2v_V3oq");
    console.log("form submitted");
    emailjs.sendForm('default_service', 'template_2320zja', '#contact-form')
